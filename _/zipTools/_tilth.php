...
if ($joinExists) { 
	...
	$tmpLoaded["zipTools/a_jszip.js"]=True;
	$tmpLoaded["zipTools/b_jszip-load.js"]=True;
	$tmpLoaded["zipTools/c_jszip-inflate.js"]=True;
	$tmpLoaded["zipTools/FileSaver.js"]=True;
